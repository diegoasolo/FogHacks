...
def predict_musiq_score(image_path, ckpt_path="musiq/weights/musiq_ckpt.npz"):
  """Wrapper function to predict quality score from an image using MUSIQ."""
  model_config, pp_config, params = get_params_and_config(ckpt_path)
  pred_mos = run_model_single_image(model_config, 1, pp_config, params, image_path)
  return float(pred_mos)
