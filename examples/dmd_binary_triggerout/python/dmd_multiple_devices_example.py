...
if __name__ == "__main__":
    ...
    ajileSystems = [aj.HostSystem(), aj.HostSystem()]

    for index, ajileSystem in enumerate(ajileSystems):
        ajileSystem.SetCommunicationInterface(aj.USB3_INTERFACE_TYPE)
        ajileSystem.SetUSB3DeviceNumber(index)
        ...
        print ("Waiting for sequence %d to start" % (sequenceID,))
    ...
    for ajileSystem in ajileSystems:
