...
def CreateProject(sequenceID=1, sequenceRepeatCount=0, frameTime_ms=-1, components=None):
    ...
    projectName = "dmd_color_testimages_example"
    ...
    for filename in filenames:
        ...
        project.CreateColorSequenceItemWithTime_FromFile(sequenceItem, imageBitplanes, filename, nextImageID, refreshRate)
